...
const CreateEvent = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-gray-50">
      ...
      {/* Navbar */}
      <main className=" flex-col  items-center p-6 md:p-12" style={{
        backgroundImage: "url('/images/main-background-card-landscape.png')", // Update with your image path
      }} >
      ...
      <main className="flex-1 flex flex-col md:flex-row items-center p-6 md:p-12" style={{
        backgroundImage: "url('/images/main-background-card-landscape.png')", // Update with your image path
      }} >
